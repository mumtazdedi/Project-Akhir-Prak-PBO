 ...
 * @author bayutri
 */
public class UpdateBarangView extends JFrame{
    JLabel lTitle = new JLabel("Update Barang");
...
//    Button
    ...
    public UpdateBarangView(String namaBarang) {
        setTitle(namaBarang);
        ...
        add(lSatuan);
        lSatuan.setBounds(40, 160, 150, 20);
        ...
        add(tfSatuan);
        tfSatuan.setBounds(200, 160, 200, 20);
